...
void replay_optics_coin_NPS_HMS(int RunNumber=0, int MaxEvent=0, int FirstEvent = 1, int MaxSegment = 1, int FirstSegment = 0, const char* fname_prefix = "nps_coin")
{
 ...
 // if (MaxEvent == 50000 && FirstEvent == 1){
  ...
  //}
  //else{
          ROOTFileNamePattern = "/volatile/hallc/nps/cploen/ROOTfiles/OPTICS/angular_sandbox/delta_opt/newfit_6p667_20260526_1226_no_offsets/rootfiles/nps_hms_optics_%d_%d_%d.root";
  //}
  ...
  // Define DEF-file+
  analyzer->SetOdefFile("DEF-files/NPS/NPS_optics.def"); //FIXME: CHANGE
  // Define cuts file
  analyzer->SetCutFile("DEF-files/HMS/PRODUCTION/CUTS/hstackana_production_cuts.def"); //FIXME: CHANGE
  ...
  analyzer->PrintReport("TEMPLATES/HMS/PRODUCTION/hstackana_production_fa22.template",
			Form("REPORT_OUTPUT/HMS/optics_NPS_HMS_report_%d_%d.report", RunNumber, MaxEvent)); //FIXME:CHANGE
